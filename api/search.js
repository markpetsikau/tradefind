export default async function handler(req, res) {
  ...
  try {
    // Use the dataset directly - no new run needed, saves money
    ...
    for (const item of shuffled) {
      ...
      let score = 60;
      if (hasTg) score += 20;
      if (captionLow.includes('ftmo') || captionLow.includes('funded') || captionLow.includes('propfirm') || captionLow.includes('prop firm') || captionLow.includes('apex')) score += 15;
